...
![Cursor Configure featurefusion: MCP tools from the running lab API (products.list, orders.*, demo.echo, lab.ping, customers.*, catalog.products.list).](docs/building-blocks/images/mcp-cursor-featurefusion-tools.png)
