        ...
        <div className="bg-background">
            <main className=" px-4 py-8 sm:px-6 lg:px-8 flex flex-col gap-4">
                <div className="flex justify-between items-start gap-4">
                    ...
                    <Suspense>
                        <CatalogFilters currentFilters={props.currentFilters} totalCount={props.catalogs.totalCount}/>
                    </Suspense>
                </div>

                {
                    props.catalogs.items.length > 0 ?
                ...
                {props.catalogs.items.length > 0 && (
                    <div className="mt-4 flex justify-center">
                        <CatalogPagination
                            ...
                            totalCount={props.catalogs.totalCount}
                        />
                    </div>
                )}
            </main>
